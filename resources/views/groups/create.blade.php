...
@section('content')
    ...
    <div class="mb-6 lg:mb-8">
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Criar Novo Grupo</h1>
        <p class="text-gray-600 mt-2">Preencha as informações abaixo para criar seu grupo</p>
    </div>
        ...
        <form method="POST" action="{{ route('groups.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       id="name"
                       value="{{ old('name') }}"
                       class="w-full px-4 py-4 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors outline-none @error('name') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
            ...
            <div>
                ...
                <textarea name="description" 
                          id="description" 
                          rows="4"
                          class="w-full px-4 py-4 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors outline-none @error('description') border-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
            ...
            <!-- Visibilidade -->
            <div>
                <label for="visibility" class="block text-sm font-medium text-gray-700 mb-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <label class="relative cursor-pointer">
                        <input type="radio" 
                               ...
                               class="sr-only">
                        <div class="border-2 rounded-2xl p-6 transition-all hover:bg-gray-50 {{ old('visibility', 'public') === 'public' ? 'border-purple-500 bg-purple-50' : 'border-gray-300' }}">
                            <div class="flex items-center">
                                <div class="w-4 border-2 rounded-full mr-3 {{ old('visibility', 'public') === 'public' ? 'border-purple-500 bg-purple-500' : 'border-gray-300' }}">
                                    <div class="w-2 h-2 bg-white rounded-full mx-auto mt-0.5 {{ old('visibility', 'public') === 'public' ? '' : 'hidden' }}"></div>
                                </div>
                                <div>
                                    <div class="flex items-center">
                                        <i class="ri-global-line text-green-600 mr-2"></i>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" 
                               ...
                               class="sr-only">
                        <div class="border-2 rounded-2xl p-6 transition-all hover:bg-gray-50 {{ old('visibility') === 'private' ? 'border-purple-500 bg-purple-50' : 'border-gray-300' }}">
                            <div class="flex items-center">
                                <div class="w-4 border-2 rounded-full mr-3 {{ old('visibility') === 'private' ? 'border-purple-500 bg-purple-500' : 'border-gray-300' }}">
                                    <div class="w-2 h-2 bg-white rounded-full mx-auto mt-0.5 {{ old('visibility') === 'private' ? '' : 'hidden' }}"></div>
                                </div>
                                <div>
                                    <div class="flex items-center">
                                        <i class="ri-lock-line text-gray-600 mr-2"></i>
    ...
    <div class="mt-8 bg-blue-50 border border-blue-200 rounded-2xl p-6">
        <div class="flex items-start">
            <i class="ri-lightbulb-line text-blue-600 mr-3 mt-1 flex-shrink-0"></i>
            <div>
                <h3 class="text-sm font-medium text-blue-900 mb-2">Dicas para criar um bom grupo:</h3>
