        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 card-shadow border border-gray-100">
            <div class="flex items-center">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-600">Total de Membros</p>
                    <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ $group->members->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 card-shadow border border-gray-100">
            <div class="flex items-center">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-lg flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                    <i data-lucide="user" class="w-5 h-5 sm:w-6 sm:h-6 text-green-600"></i>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-600">Criado por</p>
                    <p class="text-lg font-semibold text-gray-900 truncate">{{ $group->creator->name }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 card-shadow border border-gray-100 sm:col-span-2 lg:col-span-1">
            <div class="flex items-center">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-lg flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                    <i data-lucide="eye" class="w-5 h-5 sm:w-6 sm:h-6 text-purple-600"></i>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-xs sm:text-sm text-gray-600">Visibilidade</p>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl p-6 sm:p-8 card-shadow border border-gray-100">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-lg sm:text-xl font-semibold text-gray-900">Detalhes do Grupo</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                ...
                <div class="flex items-center text-sm text-gray-600">
                    <i data-lucide="user" class="w-4 h-4 mr-3 flex-shrink-0"></i>
