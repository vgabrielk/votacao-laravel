                ...
                <div class="bg-white rounded-xl p-6 card-shadow border border-gray-100">
                    ...
                    <form action="{{ route('groups.addMember', $group->id) }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <label for="name" class="block text-sm font-medium text-gray-700">E-mail do usuário</label>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                <div class="flex items-center space-x-3">
                                    <div
                                        ...
                                        <span
                                            class="text-white font-semibold text-sm">{{ substr($member->name, 0, 1) }}</span>
                                    </div>
                                    <div>
